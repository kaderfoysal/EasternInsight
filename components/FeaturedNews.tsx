...
//               <p className="text-lg md:text-xl text-gray-600 mb-4 md:mb-6 font-light ">
//                 {featuredArticle.subtitle}
//               </p>
//             )}
      ...
      >
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-6 md:p-12 flex flex-col justify-center">
            ...
            {/* Subtitle - if available */}
            {featuredArticle.subtitle && (
              <p className="text-lg md:text-base text-gray-600 mb-4 md:mb-6 font-light">
                {featuredArticle.subtitle}
              </p>
            )}
          ...
          {/* Right Column - Dynamic Image with Ratio Container */}
          <div className="md:w-1/2 flex items-center justify-center">
            <div className="ratio ratio__16x9 w-full" style={{ 
              display: 'block', 
              height: 0, 
              paddingTop: '56.25%', 
              position: 'relative', 
